                    ...
                    <div class="card border-0 shadow-sm mb-3">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <h2 class="h5 fw-normal text-muted">RECUPERAR CONTRASEÑA</h2>
                            </div>
                            ...
                            <!-- Formulario -->
                            <form action="?action=inicio&method=sendResetLink" method="POST">
                                <div class="mb-3">
                                    <input type="email" class="form-control border-light bg-light py-2" id="email" name="email" placeholder="Correo Electrónico" required>
                                </div>
                                ...
                                <div class="position-relative my-3">
                                    <hr style="border-top: 1px solid #e0e0e0; margin: 1rem 0;">
                                ...
                                <div class="text-center">
                                    <a href="?action=inicio&method=login" class="text-decoration-none small d-block mb-2">
