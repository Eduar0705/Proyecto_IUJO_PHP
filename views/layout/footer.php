            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><i class="bi bi-envelope-fill me-2"></i> info@constructora.com</li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5 class="fw-bold">Enlaces rápidos</h5>
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="?action=home" class="text-white text-decoration-none">Inicio</a></li>
                        <li class="mb-2"><a href="?action=projects" class="text-white text-decoration-none">Proyectos</a></li>
                        <li class="mb-2"><a href="?action=about" class="text-white text-decoration-none">Nosotros</a></li>
                        <li><a href="?action=contact" class="text-white text-decoration-none">Contacto</a></li>
                    </ul>
                </div>
            </div>
