        ...
        <div class="form-centered-container">
            ...
            <form method="POST" class="centered-form" id="editForm">
                ...
                <div class="d-flex justify-content-end gap-3 mt-5">
                    ...
                    <button type="submit" class="btn btn-save btn-action" id="btnActualizar">
    ...
    <script>
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                html: `Estás a punto de actualizar la información de: <strong><?= htmlspecialchars($contacto['nombre']) ?></strong><br><br>
        ...
        <?php if(isset($success) && $success): ?>
            Swal.fire({
                ...
                html: `<div class="text-center">
                           ...
                           <p class="text-muted mb-3">La información se ha guardado correctamente</p>
                       </div>`,
                icon: 'success',
                showCancelButton: true,
                confirmButtonText: '<i class="fas fa-list me-1"></i> Ver Contactos',
